...
* This method is the quickest and easiest methond, as the signing and installation can be done direct from your iDevice without downloading the .ipa file, so a Mac/PC isn't required.
* 
